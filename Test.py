...
options_builder.configure_column('layover_x','layovername_x','price','cleanprice_x',time','airline_x','totaltime_x','stops_x','logo_x','departuretime_x','arrivaltime_x','layover_y','layovername_y','price_y','cleanprice_y',time_y','airline_y','totaltime_y','stops_y','logo_y','departuretime_y','arrivaltime_y' cellRenderer=renderlogo)
